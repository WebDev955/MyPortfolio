...
const Certifications = forwardRef ((props, ref) => {
    return (
        <div ref={ref} className={styles.certMainWrapper}>
            ...
            <p><a href="public\FreeCodeCampCert-JavasScript.pdf">FreeCodeCamp - Javascript</a></p>
            <p><a href="public\FreeCodeCampCert-ResponsiveWebDesign.pdf">FreeCodeCamp - HTML & CSS</a></p>
