    ...
    return (
        <section ref = {ref} className={styles.bioMainWrapper}> 
            <header className={styles.bioHeader}>
                <h1>Hello!</h1>   
                <h2>My name is Austin Geisinger and I'm seeking a career change<br/> into the world of frontend web development. </h2> 
            </header>   
            <article className={styles.bioContent}>
                <p> 
                    Upon realizing my desire for a much needed career change, I picked up web development in the winter of 2024. I had a casual interest in web developement for many years, but never dove into a committed course with it. freeCodeAcademy changed that for me. It's been an exciting journey since. 
                <br/><br/>
