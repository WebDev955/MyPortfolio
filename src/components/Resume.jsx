      ...
      <article>
        ...
        <div>
          ...
          <ul>
            <li>
              <p>
                Schedule a large number of clients for preventative maintenance
              </p>
            </li>
            <li>
              <p>
                Send out weekly emails and called clients regarding upcoming
                service
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                Provide weekly stats and updates on clients to regional Penske
                shops
              </p>
            </li>
          </ul>
